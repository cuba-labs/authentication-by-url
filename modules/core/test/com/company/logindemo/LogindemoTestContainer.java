...
public class LogindemoTestContainer extends TestContainer {

    public LogindemoTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/logindemo/app.properties",
    ...
    public static class Common extends LogindemoTestContainer {

        public static final LogindemoTestContainer.Common INSTANCE = new LogindemoTestContainer.Common();
